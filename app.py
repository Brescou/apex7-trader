...
threading.Thread(
    target=_postmortem_loop, args=(_state["portfolio"],), daemon=True, name="apex7-postmortem"
).start()
                        ...
                        [
                            ...
                            html.Div(
                                [
                                    ...
                                    # Multi-symbol comparison panel (hidden by default)
                                    html.Div(
                                        id="compare-panel",
                                        style={"display": "none"},
                                        children=[
                            ...
                            html.Div(
                                [
                                    ...
                                    # Flash banner (hidden until alert fires)
