...
def _tab_terminal() -> html.Div:
    ...
    hidden_market_data = html.Div(
        ...
        children=[
            ...
            dcc.Input(id="screener-pe-max", type="number", placeholder="P/E max"),
            dcc.Input(id="screener-beta-max", type="number", placeholder="Beta max"),
            dcc.Input(id="screener-mktcap-min", type="number", placeholder="MktCap min ($B)"),
            dcc.Dropdown(
                id="screener-sort",
                options=[
            ...
            dcc.Store(id="chart-period-store", data="1mo"),
