...
- **Trading:** position **pyramiding** — up to `MAX_PYRAMID_LAYERS` weighted BUY adds per symbol; dynamic **watchlist** persisted in SQLite (`watchlist` table, `agents/shared/watchlist.py`).
