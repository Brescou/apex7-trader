"""core.backtest — BacktestEngine and run_backtest for APEX-7.

This module is the canonical location for backtest logic.
The root-level backtest.py remains for backward compatibility during migration.
"""
        ...
        for _ in range(n_cycles):
            ...
            for sym in WATCHLIST:
                ...
                if (
                    ...
                    and len(portfolio.positions) < MAX_POSITIONS
                ):
